...
if(isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM add_receptionist WHERE username = '$username' AND password = '$password'";
    ...
    if($count==1)
    {
        ...
        echo "<script>window.location.href='http://localhost/hospital/admin/userpannel/userReceptionist.php';</script>";
    }
    else{
